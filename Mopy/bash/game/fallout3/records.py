...
from ...brec import MelRecord, MelGroups, MelStruct, FID, MelGroup, \
    ...
    MelReferences, MelColorInterpolator, MelValueInterpolator, MelUnion, \
    AttrValDecider, MelRegnEntrySubrecord, SizeDecider, MelFloat, MelSInt8, \
    ...
    MelWthrColors, MreLeveledListBase, MreDialBase, MreActorBase, \
...
from ...brec import MelModel, MelVector
...
class MreNpc(MreActor):
    ...
    class MelNpcData(MelVector):
        ...
        def __init__(self, struct_format):
            super(MreNpc.MelNpcData, self).__init__(b'DATA', struct_format,
                u'health', (u'attributes', [0] * 21))

    class MelNpcDnam(MelVector):
