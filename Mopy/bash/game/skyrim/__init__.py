...
class SkyrimGameInfo(GameInfo):
    ...
    allTags = {
        ...
        u'Destructible', u'Factions', u'Filter', u'Graphics', u'Invent',
        u'Keywords', u'MustBeActiveIfImported', u'Names', u'NoMerge',
        u'NPC.Class', u'NPC.Race', u'Relev', u'ObjectBounds', u'Sound',
    ...
    patchers = (u'PatchMerger', # PatchMerger must come first!
        ...
        u'ImportInventory', u'KeywordsImporter', u'ListsMerger',
